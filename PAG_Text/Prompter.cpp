...
const std::vector<std::string> Prompter::invalidTextResponses = {
	...
	"Maybe.",
	"Ha, so true.",
	"[insert invalid command response here]",
	...
	"How would that work?",
	"Sometimes.",
	"Normally that's true, but not today.",
	"Maybe some other time.",
	"Hm.",
	"Something like that.",
	"I don't usually think this way.",
	"Anyway...",
	"But alas.",
	"I forgot what I said.",
	"There's no way that came out of my mouth just now.",
	"Who said that?",
	...
	"Uh-huh.",
	"Is that profane?",
	"People would judge me for that.",
	"I think I just spoke in a foreign language.",
	"Moving on.",
	"Haven't got a programmed response to that one."
};
